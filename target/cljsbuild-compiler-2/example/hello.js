...
goog.require('example.crossover.shared');
example.hello.say_hello = (function say_hello(){return alert(example.crossover.shared.make_example_text());
});
...
var add_some_numbers__delegate = function (numbers){return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,numbers);
};
...
add_some_numbers.cljs$lang$applyTo = (function (arglist__7976){
var numbers = cljs.core.seq(arglist__7976);
