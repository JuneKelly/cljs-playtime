...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj9075 = {};return obj9075;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3481__auto__ = this$;if(and__3481__auto__)
...
{var x__4120__auto__ = (((this$ == null))?null:this$);return (function (){var or__3493__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4120__auto__)]);if(or__3493__auto__)
{return or__3493__auto__;
} else
{var or__3493__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3493__auto____$1)
...
return (function (p__9076){var vec__9077 = p__9076;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9077,0,null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9077,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__9078){var vec__9079 = p__9078;var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9079,0,null);var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9079,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(goog.events.EventType)], 0))));
});
