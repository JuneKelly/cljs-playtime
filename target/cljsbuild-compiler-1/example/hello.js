...
goog.require('example.crossover.shared');
example.hello.say_hello = (function say_hello(){return alert(example.crossover.shared.make_example_text.call(null));
});
...
add_some_numbers.cljs$lang$applyTo = (function (arglist__6420){
var numbers = cljs.core.seq(arglist__6420);
